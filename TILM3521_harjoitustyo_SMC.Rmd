...
\KwResult{Posteriorijakauma $x_{k+1}^i$.}
\Begin{
  \For{$k=1,2,\ldots,t$}{
    \For{$i=1,2,\ldots,N$}{
      ...
      \If{$\hat{N}_{eff}< N_{th}$}{Otetaan uudet $N$ otosta palauttaen joukosta $\{x_{1:k}^i\}_{i=1}^N$, missä otoksen $i$ todennäköisyys on $w^i_{k|k}$.}
