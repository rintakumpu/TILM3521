...
Marginalisointi edellä esitetyllä tärkeytyspainolla lisää algoritmin aikakompleksisuutta $\mathcal{O}(N)\rightarrow\mathcal{O}(N^2)$, joten isoilla arvoilla $N$ pitää käyttää jotakin toista versiota algoritmista. Esimerkiksi $\mathcal{O}(N\text{log}(N))$ versio tästä marginaalihiukkassuotimesta on olemassa.
...
Del Moral artikkelissa "Nonlinear Filtering: Interacting Particle Resolution" (1996), SMC-menetelmät termiä Liu ja Chen artikkelissa "Sequential Monte Carlo Methods for Dynamic Systems" (1998).
