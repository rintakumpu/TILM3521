...
Lineaarisen stokastisen suodinongelman ratkaisu on tunnettu ... Alaluku noudattaa suodatinongelman historian kuvauksessa Crisanin artikkelia "The stochastic filtering problem: a brief historical account" (2014) ja SMC-menetelmien kuvauksessa Cappé &al artikkelia "An overview of existing methods and recent
advances in sequential Monte Carlo" (2007). SMC-menetelmien osalta sivuutetaan siis viimeisen kymmenen vuoden kehitys. Tämä on linjassa tutkielman varsinaisen teoriaosuuden kanssa. 
